...
genres_data: list[dict[str, Any]] = [
    {"_id": genres_data_ids[0], "data": {"id": genres_data_ids[0], "name": "action"}},
    {"_id": genres_data_ids[1], "data": {"id": genres_data_ids[1], "name": "drama"}},
    {"_id": genres_data_ids[2], "data": {"id": genres_data_ids[2], "name": "comedy"}},
]
...
films_data: list[dict[str, Any]] = [
    {
        ...
        "data": {
            ...
            "directors": [
                {
                    "id": persons_data[0]["data"]["id"],
                    "name": persons_data[0]["data"]["full_name"],
                }
            ],
            "actors": [
                {
                    "id": persons_data[1]["data"]["id"],
                    "name": persons_data[1]["data"]["full_name"],
                }
            ],
            "writers": [
                {
                    "id": persons_data[2]["data"]["id"],
