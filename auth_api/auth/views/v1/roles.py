...
class RolesAPI(MethodView):
    ...
    def put(self, role_id):
        ...
        updated_role = role_service.update_role(role_id, role_name, role_description)
...
bp.add_url_rule("", defaults={"role_id": None}, view_func=view, methods=["GET", "POST"])
bp.add_url_rule(
    "",
    view_func=view,
    methods=[
...
bp.add_url_rule("/<uuid:role_id>", view_func=view, methods=["GET", "PUT", "DELETE"])
